...
//                 onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
//                 disabled={currentPage === 1}
//                 className={`px-4 py-2 rounded-md border ${currentPage === 1 ? 'bg-gray-300 text-gray-600' : 'bg-white text-black hover:bg-gray-200'}`}
//               >
//                 Previous
//               </button>
//               <span className="px-4 py-2 flex items-center text-black dark:text-white">
...
//                 onClick={() => setCurrentPage(prev => Math.min(prev + 1, totalPages))}
//                 disabled={currentPage === totalPages}
//                 className={`px-4 py-2 rounded-md border ${currentPage === totalPages ? 'bg-gray-300 text-gray-600' : 'bg-white text-black hover:bg-gray-200'}`}
//               >
//                 Next
//               </button>
//             </div>
